...
const stringEcho = (arg) => arg; //Now this function its fine except notice its dedicated to a string type only
...
const echo = (arg) => arg; //Here now this also works except it works with any type that we would pass in to these function
...
class StateObject {
    ...
    data; //The type of the data would be that same generic type we specified
    constructor(value) {

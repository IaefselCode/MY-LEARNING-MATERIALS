...
export default PutorPatch;

//NOTE:
//tO Update a resource completely, use PUT.
//To update a resource partially, use PATCH.
//The main difference between PUT and PATCH is that PUT replaces the entire resource with the new data, while PATCH only updates the specified fields in the resource.
//Also when updating we need to provide the id of the resource we want to update. i  the URL like this: https://jsonplaceholder.typicode.com/posts/1
//In this example, we are updating the post with ID 1. The body contains the new data for the post, which will replace the existing data for that post.